...
from probability_models import outperform_probability
from strength_of_schedule import calculate_strength_of_schedule, ratings_2023
from data_loader import get_schedule_df
from offense import calc_total_offense
from defense import calc_total_defense
from special_teams import calc_special_teams_rating
...
def calc_overall_rating(team_abbr, sos_dict, league_avg):
    ...
    from data_loader import update_df
