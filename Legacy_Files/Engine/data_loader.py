import pandas as pd
import os
from Legacy_Files.Engine.constants import full_to_abbr

# Adjust base path to point one level above the Engine folder
...
def get_schedule_df():
    ...
    if _schedule_df is None:
        path = os.path.join(BASE_PATH, "NFL", "raw_data", "Full_Schedule.csv")
        _schedule_df = pd.read_csv(path)
    return _schedule_df
...
def get_team_row(df, team_input, column=None):
    from Engine.constants import abbr_to_full
...
def get_team_total_offense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_team_total_offense.csv")
    return pd.read_csv(file_path)

def get_team_situational_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_team_situational.csv")
    return pd.read_csv(file_path)

def get_team_drive_stats_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_team_drive_stats.csv")
    return pd.read_csv(file_path)

def get_rushing_offense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_rushing_offense.csv")
    return pd.read_csv(file_path)

def get_passing_offense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_passing_offense.csv")
    return pd.read_csv(file_path)
...
def get_total_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "Total_Defense.csv")
    return pd.read_csv(file_path)

def get_situational_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_situational_defense.csv")
    return pd.read_csv(file_path)

def get_drive_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_drive_defense.csv")
    return pd.read_csv(file_path)

def get_rushing_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_rushing_defense.csv")
    return pd.read_csv(file_path)

def get_passing_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_passing_defense.csv")
    return pd.read_csv(file_path)

def get_scoring_defense_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "cleaned_scoring_defense.csv")
    return pd.read_csv(file_path)
...
def get_special_teams_df():
    file_path = os.path.join(BASE_PATH, "NFL", "raw_data", "Total_Special_Teams.csv")
    return pd.read_csv(file_path)
